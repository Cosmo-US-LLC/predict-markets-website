    ...
    <section className="bg-[#020b10] py-12 md:py-20 px-4 md:px-8">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col gap-2 items-center text-center mb-12 md:mb-12">
          ...
          <p className="text-[#cacaca] text-base leading-6 tracking-[0.32px] max-w-[868px]">
            {description}
          </p>
        </div>

        {/* Comparison Table */}
        <div className="bg-[#0f0f0f] border-[0.5px] border-[#2104ff] rounded-[15px] overflow-hidden">
          <div className="overflow-x-auto">
            <div className="min-w-[972px]">
              {/* Table Header */}
              <div className="border-b border-white/20 bg-[#2104ff] px-[55px] py-4">
