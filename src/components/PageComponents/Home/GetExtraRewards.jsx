...
// Images
const checkIcon = "https://www.figma.com/api/mcp/asset/adf9c677-68c8-4f65-a1fb-2173bbe7677d";
const infoIcon = "https://www.figma.com/api/mcp/asset/11818e11-7561-4fbe-95ed-4e15d8b42575";
    ...
    <section className="bg-[#020b10] py-12 md:py-[60px] px-4 md:px-8 lg:px-[80px]">
      <div className="max-w-[1280px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex flex-col gap-6 flex-1 max-w-[497px]">
            {/* Title and Subtitle */}
              ...
              <CarouselContent>
                {membershipCards.map((card, index) => (
                  <CarouselItem key={card.id || index} className="basis-full">
                    <div
                      className="backdrop-blur-[7.644px] border-[0.764px] border-[rgba(255,255,255,0.1)] rounded-[15.289px] p-6 md:p-8 flex flex-col lg:flex-row gap-[58px] items-center min-h-[349px] relative overflow-hidden"
                    >
                      {/* Background Gradient */}
                      <div
                      ...
                      />
                      <div className="relative z-10 w-full flex flex-col lg:flex-row gap-[58px] items-center">
                      {/* Left Side - NFT Card */}
                      <div className="flex flex-col gap-5 w-full lg:w-[294px]">
                        ...
                        {/* NFT Card */}
                        <div
                          className="bg-black border-[0.5px] border-white rounded-[15px] h-[172px] w-full relative overflow-hidden shadow-lg"
                        ...
                        >
                          ...
                          {card.decorativeImage && (
                            <div className="absolute right-[-0.5px] top-1/2 -translate-y-1/2 w-[308px] h-[180px] opacity-85">
                          ...
                          {/* Coin Image */}
                          {card.coinImage && (
                            <div className="absolute left-[128.5px] top-[3.5px] w-[160.868px] h-[172.077px] flex items-center justify-center">
                              <div className="rotate-[20.87deg] w-[119.283px] h-[138.675px]">
                                <img
                                  src={card.coinImage}
                                  alt=""
                          ...
                          {/* Logo */}
                          {card.logoImage && (
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-[5.326px]">
                              <div className="bg-[#2104ff] flex items-center justify-center p-[2.817px] rounded-[2.959px] w-[20.121px] h-[20.121px]">
                                <div className="w-[9.838px] h-[12.355px] grid grid-cols-3 grid-rows-3 gap-[2.746px]">
                                  {[...Array(8)].map((_, i) => (
                                    <div key={i} className="bg-white rounded-[0.539px] w-[2.974px] h-[2.746px]" />
                                  ))}
                                </div>
                              </div>
                              <img
                                src={card.logoImage}
                                alt="PredictMarkets"
                                className="h-[8.829px] w-[101.553px]"
                                onError={(e) => {
                                  e.target.style.display = 'none';
                                }}
                              />
                        ...
                        {card.benefits && card.benefits.map((benefit, idx) => (
                          <div key={idx} className="flex gap-3 items-center">
                            ...
                            <div className="flex gap-1 items-start flex-1">
                              <p className="text-white text-base font-medium leading-[1.1] capitalize">
                                {benefit}
                              </p>
                              <img
                                src={infoIcon}
                                alt=""
                                className="w-[28.183px] h-[28.183px] shrink-0"
                                onError={(e) => {
                                  e.target.style.display = 'none';
                                }}
                              />
