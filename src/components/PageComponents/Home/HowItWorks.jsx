...
export default function HowItWorks({
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1220px] mx-auto px-4 md:px-8 py-12 md:py-16 relative gradient-border-rounded flex flex-col gap-12">
        ...
        <h4 className="absolute top-[18%] left-[38%] z-10 max-w-[300px] text-center text-[#ffffff] text-base md:text-[20px] font-[500] leading-[28px] w-full whitespace-pre-wrap">
        PredictMarkets generates daily revenue from <br /> trading fees
        </h4>
        <h4 className="absolute top-[51%] left-[1%] z-10 max-w-[300px] text-center text-[#ffffff] text-base md:text-[20px] font-[500] leading-[28px] w-full whitespace-pre-wrap">
