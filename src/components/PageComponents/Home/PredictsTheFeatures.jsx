...
export default function PredictsTheFeatures({
  ...
  return (
    <section
      className="w-full py-12 md:py-[84px] relative"
      style={{
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="flex flex-col gap-1.5 md:gap-[6px] items-start">
                <h4 className="text-white text-base md:text-[20px] font-medium leading-[28px] capitalize w-full">
                  {feature.title}
                </h4>
                <p className="text-[#cacaca] text-base md:text-[16px] font-normal leading-[24px] tracking-[0.32px] w-full whitespace-pre-wrap">
                  {feature.description}
                </p>
              </div>
            </div>
