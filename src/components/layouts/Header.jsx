...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#020b10] border-b border-[#1a1a1a]">
        ...
        <div className="flex items-center gap-[7px]">
          ...
          <div ref={languageRef} className="hidden md:flex items-center relative">
            <button
              ...
              className="flex items-center gap-2 px-[12px] py-[2px] h-[37px] bg-white/20 border border-white/20 rounded-full hover:bg-white/30 transition-colors"
            >
              <Globe className="w-[18px] h-[18px] text-white" />
              <span className="text-white text-sm font-normal">English</span>
              <ChevronDown className={cn("w-[12px] h-[12px] text-white transition-transform", isLanguageOpen && "rotate-180")} />
            </button>
            {isLanguageOpen && (
              <div className="absolute top-full mt-2 right-0 bg-white border border-[#767676] rounded-md shadow-lg py-2 min-w-[120px] z-50">
                <button 
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] bg-[#020b10] border-l border-[#1a1a1a] p-6">
              <SheetClose asChild>
                <Button
                  variant="ghost"
                  size="icon"
              ...
              <div className="flex flex-col gap-6 mt-8">
                ...
                <div className="pt-4 border-t border-white/20">
                  <button
                    onClick={() => setIsLanguageOpen(!isLanguageOpen)}
                    className="flex items-center gap-2 px-4 py-2 w-full bg-white/20 border border-white/20 rounded-full hover:bg-white/30 transition-colors"
                  >
                    <Globe className="w-[18px] h-[18px] text-white" />
                    <span className="text-white text-sm font-normal">English</span>
                    <ChevronDown className="w-[12px] h-[12px] text-white ml-auto" />
                  </button>
                  {isLanguageOpen && (
                    <div className="mt-2 bg-white/10 border border-white/20 rounded-md py-2">
                      <button className="w-full text-left px-4 py-2 text-white text-sm hover:bg-white/10">
                        English
                      </button>
                    </div>
                  )}
